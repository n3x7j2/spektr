import { Box, Portal, PortalProps, SxProps, Theme } from '@mui/material';
import { rem, useDidUpdate, useForceUpdate, useMediaQuery, useReducedMotion } from '@spektr/common';
...
export interface NotificationsProps extends React.ComponentPropsWithoutRef<'div'> {
...
export const Notifications: React.FC<NotificationsProps> & NotificationsStaticMethods = ({
  ...
  const reduceMotion = prefersReducedMotion ? shouldReduceMotion : false;
    ...
    <Portal container={target}>
      <Box
        ...
        sx={{
          ...
          position: 'fixed',
          zIndex,
          ...getPositionStyles(positioning, '1rem'),
        }}
        {...others}
      >
...
Notifications.displayName = '@spketr/notifications/Notifications';
